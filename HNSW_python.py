...
with open('glove-25-angular-cosine-train.ind', 'wb') as f:
...
with open('glove-25-angular-l2-train.ind', 'wb') as f:
    picklestring = pickle.dump(hnsw2, f, pickle.HIGHEST_PROTOCOL)
...
hnsw.search(test[1], 10)


# In[46]:


hnsw2.search(test[1], 10)
